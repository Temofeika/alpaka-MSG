...
import 'package:alpaka_msg/pages/chat_list/unread_bubble.dart';
...
class _SpaceViewState extends State<SpaceView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: AlpakaThemes.isColumnMode(context)
            ? null
            : Center(child: CloseButton(onPressed: widget.onBack)),
        automaticallyImplyLeading: false,
        titleSpacing: AlpakaThemes.isColumnMode(context) ? null : 0,
        title: ListTile(

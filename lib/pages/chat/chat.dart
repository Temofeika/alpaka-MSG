...
import 'package:alpaka_msg/pages/chat/chat_view.dart';
import 'package:alpaka_msg/pages/chat/event_info_dialog.dart';
import 'package:alpaka_msg/pages/chat/start_poll_bottom_sheet.dart';
import 'package:alpaka_msg/pages/chat_details/chat_details.dart';
import 'package:alpaka_msg/utils/adaptive_bottom_sheet.dart';
...
import 'package:alpaka_msg/utils/other_party_can_receive.dart';
import 'package:alpaka_msg/utils/platform_infos.dart';
import 'package:alpaka_msg/utils/show_scaffold_dialog.dart';
import 'package:alpaka_msg/widgets/adaptive_dialogs/show_modal_action_popup.dart';
...
class ChatController extends State<ChatPageWithRoom>
  ...
  Future<void> scrollToEventId(
    ...
    await scrollController.scrollToIndex(
      eventIndex + 1,
      duration: AlpakaThemes.animationDuration,
      ...
      children: [
        ...
        ValueListenableBuilder(
          ...
          builder: (context, displayChatDetailsColumn, _) =>
              !AlpakaThemes.isThreeColumnMode(context) ||
                  room.membership != Membership.join ||
                  !displayChatDetailsColumn
              ? const SizedBox(height: double.infinity, width: 0)
              : Container(
                  width: AlpakaThemes.columnWidth,

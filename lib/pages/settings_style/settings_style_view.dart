...
import 'package:alpaka_msg/pages/chat/events/state_message.dart';
import 'package:alpaka_msg/utils/account_config.dart';
import 'package:alpaka_msg/utils/color_value.dart';
...
class SettingsStyleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: !AlpakaThemes.isColumnMode(context),
        centerTitle: AlpakaThemes.isColumnMode(context),
                            ...
                            Opacity(
                              ...
                              child: ImageFiltered(
                                ...
                                child: MxcImage(
                                  ...
                                  fit: BoxFit.cover,
                                  isThumbnail: true,
                                  width: AlpakaThemes.columnWidth * 2,
                                  height: 212,
                                ),
                              ),
                            ),

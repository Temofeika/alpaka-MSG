...
import 'package:alpaka_msg/pages/chat_search/chat_search_files_tab.dart';
import 'package:alpaka_msg/pages/chat_search/chat_search_images_tab.dart';
import 'package:alpaka_msg/pages/chat_search/chat_search_message_tab.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: MaxWidthBody(
        ...
        child: Column(
          children: [
            if (AlpakaThemes.isThreeColumnMode(context))

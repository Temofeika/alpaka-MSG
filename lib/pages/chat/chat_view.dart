...
import 'package:alpaka_msg/pages/chat/chat_app_bar_list_tile.dart';
import 'package:alpaka_msg/pages/chat/chat_app_bar_title.dart';
import 'package:alpaka_msg/pages/chat/chat_event_list.dart';
import 'package:alpaka_msg/pages/chat/encryption_button.dart';
import 'package:alpaka_msg/pages/chat/jitsi_popup_button.dart';
import 'package:alpaka_msg/pages/chat/pinned_events.dart';
import 'package:alpaka_msg/pages/chat/reply_display.dart';
import 'package:alpaka_msg/utils/account_config.dart';
import 'package:alpaka_msg/utils/localized_exception_extension.dart';
import 'package:alpaka_msg/widgets/chat_settings_popup_menu.dart';
...
class ChatView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bottomSheetPadding = AlpakaThemes.isColumnMode(context) ? 16.0 : 8.0;
          ...
          builder: (BuildContext context, snapshot) {
            ...
            return Scaffold(
              appBar: AppBar(
                ...
                titleSpacing: AlpakaThemes.isColumnMode(context) ? 24 : 0,
                          ...
                          if (controller.room.isExtinct)
                            ...
                            Container(
                              ...
                              constraints: const BoxConstraints(
                                maxWidth: AlpakaThemes.maxTimelineWidth,
                              ),

...
enum AppSettings<T> {
  ...
  applicationName<String>('chat.fluffy.application_name', 'Alpaka MSG'),
  defaultHomeserver<String>('chat.fluffy.default_homeserver', 'alpakasoft.online'),
  ...
  presetHomeserver<String>('chat.fluffy.preset_homeserver', 'alpakasoft.online'),

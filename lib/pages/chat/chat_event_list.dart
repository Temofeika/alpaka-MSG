...
import 'package:alpaka_msg/pages/chat/events/message.dart';
import 'package:alpaka_msg/pages/chat/seen_by_row.dart';
import 'package:alpaka_msg/pages/chat/typing_indicators.dart';
...
class ChatEventList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final horizontalPadding = AlpakaThemes.isColumnMode(context) ? 8.0 : 0.0;

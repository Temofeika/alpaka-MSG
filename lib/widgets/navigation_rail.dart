...
import 'package:alpaka_msg/pages/chat_list/navi_rail_item.dart';
import 'package:alpaka_msg/pages/chat_list/start_chat_fab.dart';
      ...
      child: SafeArea(
        child: StreamBuilder(
          ...
          builder: (context, _) {
            ...
            return SizedBox(
              width: AlpakaThemes.isColumnMode(context)
                  ? AlpakaThemes.navRailWidth
                  : AlpakaThemes.navRailWidth * 0.75,
              child: Column(
                children: [
                  Expanded(
